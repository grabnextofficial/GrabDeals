  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-slate-950 p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 right-10 w-80 h-80 rounded-full bg-blue-600/20 blur-[100px] animate-blob" />
        <div className="absolute bottom-10 left-10 w-96 h-96 rounded-full bg-orange-600/15 blur-[120px] animate-blob animation-delay-2000" />
        <div className="absolute bottom-1/3 right-1/4 w-72 h-72 rounded-full bg-purple-600/20 blur-[100px] animate-blob animation-delay-4000" />
      </div>
      ...
      <div className="relative w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="backdrop-blur-2xl bg-slate-900/60 border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-3xl p-8 md:p-10 transition-all duration-300 hover:border-white/20">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-400 text-sm text-center font-medium mt-2">Create an account to get instant access</p>
          </div>

          <form onSubmit={handleRegister} className="space-y-5">
            {/* Full Name Field */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-wider block" htmlFor="name">
                Full Name
              </label>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-slate-900 px-4 text-slate-400 text-xs font-semibold uppercase tracking-wider">Already registered?</span>
            </div>
          </div>
